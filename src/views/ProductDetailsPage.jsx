...
import { getRelatedProducts } from '../utils/data'
...
export default function ProductDetailsPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: category?.name, path: categoryPath(product.categorySlug) },
    {
      label: subcategory?.name,
      path: subcategoryPath(product.categorySlug, product.subcategorySlug),
    },
    { label: product.name },
  ]
  ...
  return (
    <>
      <Seo
        ...
        ogType="product"
        jsonLd={mergeJsonLd([
          buildProductJsonLd({ product, category, subcategory }),
